    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnagregar.setOnClickListener( new View.OnClickListener(){
            public void onClick(View v){
                ...
                valores.put(GestorBD.TablaDatos.COLUMNA_MODELO, etmodelo.getText().toString());
                valores.put(GestorBD.TablaDatos.COLUMNA_PATENTE,etpatente.getText().toString());
                valores.put(GestorBD.TablaDatos.COLUMNA_PRECIO,etprecio.getText().toString());
